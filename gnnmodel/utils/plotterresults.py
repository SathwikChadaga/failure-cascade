# Class to plot the final state errors comprehensively
...
class resultPlotter():
    ...
    def plotFinalStateError(self, errorVectorList, ny, nx, predictMode, titleText, lineFailureFrequencyList = None):
        ...
        for ii in range(ny):  
            for jj in range(nx):
                ...
                axs[ii, jj].set_title('Scaling = ' + '{:.2f}'.format(self.scalingList[ii*nx+jj]))
